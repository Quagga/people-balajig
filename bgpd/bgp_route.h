...
extern void bgp_redistribute_add (struct prefix *, struct in_addr *, u_int32_t, u_char, safi_t);
extern void bgp_redistribute_delete (struct prefix *, u_char, safi_t);
extern void bgp_redistribute_withdraw (struct bgp *, afi_t, int, safi_t);
